...
namespace Sunny.UI.Demo
{
    public partial class FMain : UIHeaderAsideMainFrame
    {
        public FMain()
        {
            ...
            Aside.CreateChildNode(parent, AddPage(new UITestLabelForm(), ++pageIndex));
            Aside.CreateChildNode(parent, AddPage(new UITestForm(), ++pageIndex));
            //示例设置某个节点的小红点提示  
            Aside.ShowTips = true;
            ...
            //Aside.CreateChildNode(parent, AddPage(new UITestForm()));
