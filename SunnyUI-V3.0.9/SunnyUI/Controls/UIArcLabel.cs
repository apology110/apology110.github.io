...
namespace Sunny.UI
{
    ...
    public class UIArcLabel : UIUCLabel
    {
        ...
        public UIArcLabel()
        {
            ...
            this.conduitColor = Color.Empty;
            this.liquidColor = Color.Empty;
        ...
        /// 转动流速，越小，速度越快
        /// </summary>
        [Description("转动流速，越小，速度越快"), Category("自定义")]
        ...
        /// 获取或设置Label的宽度
        /// </summary>
        [Description("Label的宽度，当ConduitStyle的值是Horizontal_Tilt_Up,Horizontal_Tilt_Down,Vertical_Tilt_Left,Vertical_Tilt_Right时有效，其他时候将根据管道大小使用自动宽度"), Category("自定义")]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (conduitStyle)
            {
                ...
                case ConduitStyle.Horizontal_None_None:
                    ...
                    linePath.AddLine(5, this.Height / 2, this.Width, this.Height / 2);
                    break;
